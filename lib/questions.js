const mainMenu = [
    {
        ...
        choices: ['Add new DEPARTMENT', 'View all DEPARTMENTS', 'Add new EMPLOYEE', 'View all EMPLOYEE', 'Add new ROLE', 'View all ROLE', 'Update EMPLOYEE', 'Quit', ]
    }
];
...
function updateNewEmpInfo(rolesList, employeeList) { 
    return [
    {
        name: 'name',
            type: 'list',
            message: 'What is the updated NAME of the employee?',
            choices: employeeList
        },
        {
            name: 'role',
            type: 'list',
            message: 'What is the updated ROLE of the emplolyee?',
            choices: rolesList
        },
];
...
//questions
module.exports = {
    addEmployeeInfo, mainMenu, addDeptInfo, addRole, updateNewEmpInfo
}